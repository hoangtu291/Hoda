...
<footer>
    ...
    <symbol id="icon-chat-filled" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    <symbol id="icon-plus" fill="currentColor" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
        <path
            d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" />
    </symbol>
    <symbol id="icon-plus-filled" fill="currentColor" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    <symbol id="icon-user" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    <symbol id="icon-user-filled" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    <div id="modalContact" class="modal fade" role="dialog" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h5>Văn phòng tầng B, Tòa Nhà Universial. Số 900A Đường Quang Trung, Cần Thơ.</h5>
                </div>
            </div>
        </div>
    </div>
