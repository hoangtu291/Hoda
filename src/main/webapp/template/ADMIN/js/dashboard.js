(function($) {
  ...
  $(function() {
    if ($("#performaneLine").length) {
      ...
      saleGradientBg.addColorStop(0, 'rgba(66, 255, 18, 0.18)');
      saleGradientBg.addColorStop(1, 'rgba(66, 255, 18, 0.02)');
      var saleGradientBg2 = graphGradient2.createLinearGradient(100, 0, 50, 150);
      saleGradientBg2.addColorStop(0, 'rgba(29, 144, 0, 0.19)');
      saleGradientBg2.addColorStop(1, 'rgba(29, 144, 0, 0.03)');
      var salesTopData = {
          ...
          datasets: [{
              ...
              pointBackgroundColor: ['#75FA53)', '#75FA53', '#75FA53', '#75FA53','#75FA53)', '#75FA53', '#75FA53', '#75FA53','#75FA53)', '#75FA53', '#75FA53', '#75FA53','#75FA53)'],
            ...
            pointBackgroundColor: ['#1d9000)', '#1d9000', '#1d9000', '#1d9000','#1d9000)', '#1d9000', '#1d9000', '#1d9000','#1d9000)', '#1d9000', '#1d9000', '#1d9000','#1d9000)'],
              pointBorderColor: ['#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff',],
        }]
      };
