                ...
                <div class="list-post">
                    <div class="post">
                        ...
                        <div class="content-post p-2">
                            ...
                            <p>
                                Nội dung bài viết, Nội dung bài viết, Nội dung bài viết
                        ...
                        <div class="footer-post d-flex flex-row p-2">
                            <div class="d-flex justify-content-start">
                                <img src="./images/Ellipse 20.png" class="d-block rounded-circle" alt="" style="height: 28px; width: 28px;">
                    ...
                    <div class="post">
                        <div class="header-post">
                            <nav class="navbar navbar-expand p-2 gap-2">
                                <img src="./images/Ellipse 20.png" class="d-block rounded-circle" alt=""
                                     style="height: 44px; width: 44px;">
                                <div>
                                    <h5>Người dùng 01</h5>
                        ...
                        <div class="content-post p-2">
                            <h6>[Tiêu đề bài viết]</h6>
                            <p>Nội dung bài viết, Nội dung bài viết, Nội dung bài viết</p>
                            <p>Xem thêm</p>
                        </div>
                        ...
                        <div class="footer-post">
                            <nav class="navbar navbar-expand p-2 gap-2">
                                <img src="./images/Ellipse 20.png" class="d-block rounded-circle" alt=""
                                     style="height: 28px; width: 28px;">
                                <p class="ps-2">Thêm bình luận...</p>
                                <ul class="navbar-nav ms-auto gap-4" id="list-header">
                                    <li class="nav-item">
                                        <button class="d-block">
                                            <svg>
                                            <use xlink:href="#icon-emoji" />
