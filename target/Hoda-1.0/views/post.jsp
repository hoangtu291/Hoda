                        ...
                        <div class="post">
                            <div class="header-post">
                                <nav class="navbar navbar-expand ps-2 pe-2 gap-2">
                                    <img src="${post.getUserModel().getProfileModel().getAvatar()}" class="d-block rounded-circle" alt=""
                            ...
                            <div class="image-post">
                                <div id="carouselImage-${post.getId()}" class="carousel slide" data-bs-ride="carousel">
                                    <div class="carousel-inner">
                                        <c:forEach items="${post.getImageModels()}" var="image" varStatus="loop">
                                            <div class="carousel-item <c:if test="${loop.index == 0}">active</c:if>">
                                                <img src="${image.getUrl()}" class="w-100" alt="...">
                                            </div>
                                        </c:forEach>
                                    </div>
                                    <button class="carousel-control-prev" type="button" data-bs-target="#carouselImage-${post.getId()}" data-bs-slide="prev">
                                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                        <span class="visually-hidden">Previous</span>
                                    </button>
                                    <button class="carousel-control-next" type="button" data-bs-target="#carouselImage-${post.getId()}" data-bs-slide="next">
                            ...
                            <div class="footer-post d-flex flex-row p-2">
                                <div class="d-flex justify-content-start">
                                    <img src="${post.getUserModel().getProfileModel().getAvatar()}" class="d-block rounded-circle" alt="" style="height: 28px; width: 28px;">
                                    <input class="add-comment ps-2" type="text" placeholder="Thêm bình luận..." data-bs-toggle="modal" data-bs-target="#modalComment">
                                </div>
                                        ...
                                        <div class="modal-content">
                                                    ...
                                                    <ul class="list-comment p-0 m-0">
                                                        <li class="d-flex flex-row comment-1">
                                                            ...
                                                            <div class="d-flex flex-column">
                                                                <div class="user-comment"><b>Người dùng 2</b></div>
                                            ...
                                            <div class="modal-footer">
                                                <nav class="navbar navbar-expand p-2">
                                                    <img src="./images/Ellipse 20.png" class="d-block rounded-circle" alt=""
                                                         style="height: 28px; width: 28px;">
                                                    <input class="add-comment" type="text" placeholder="Thêm bình luận...">
